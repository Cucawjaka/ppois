...
class HRDepartment:
    ...
    def hire_employee(
        ...
        new_employee: Employee = Employee(
            self.id_generator.create_int_id(),
            first_name,
            last_name,
            permission,
            email
    ...
    def fire_employee(self, employee_id: int) -> None:
        for employee in self.employees:
            ...
            raise EmployeeNotFoundError(f"Сотрудник с id {employee_id} не найдем")


    def change_employee_permission(self, employee: Employee, new_permission: Permission):
