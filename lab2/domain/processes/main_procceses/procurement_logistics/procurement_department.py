...
from domain.processes.main_procceses.procurement_logistics.purchase_order import PurchaseOrder
...
class ProcurementDepartment:
    ...
    def create_contract(self, supplier: Supplier, items: dict[Material | Product, int]) -> Contract:
