...
from core.exceptions import NotEnoughItem
from core.utils.id_generator import IDGenerator

from domain.processes.core.warehouse_logistics.cargo import Cargo
from domain.processes.core.warehouse_logistics.cargo_sorting_plan import CargoSortingPlan
...
class LogisticsCenter:
    ...
    def receive_cargo(self, cargo: Cargo, cargo_sorting_plan: CargoSortingPlan) -> None:
        ...
        destination_map: dict[WareHouse, dict[Material | Product, int]] = cargo_sorting_plan.distribution_map
    ...
    def send_cargo(self, cargo_sorting_plan: CargoSortingPlan, destination: str) -> Cargo:
        destination_map: dict[WareHouse, dict[Material | Product, int]] = cargo_sorting_plan.distribution_map
